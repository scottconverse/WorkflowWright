...
<main id="top">
  ...
  <div class="strip">
    <div class="wrap strip-in">
      ...
      <span class="fact"><b>51 tests</b>, no network or token spend</span>
...
make test   <span class="t-dim"># 51 tests, no network</span></pre>
  ...
  <section class="wrap">
    ...
    <ul class="limits" style="max-width:64ch">
      ...
      intake step.</li>
      <li><b>Running a workflow needs the <code>claude</code> CLI</b> on PATH. Designing,
      rendering, critiquing, and scaffolding do not.</li>
